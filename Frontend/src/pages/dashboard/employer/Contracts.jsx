    ...
    return (
        <div style={{ padding: "1.5rem", maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ marginBottom: "2rem" }}>
                <h1 className="font-heading" style={{ fontSize: "1.5rem", fontWeight: 800, color: "hsl(var(--text))" }}>Active Contracts</h1>
            ...
            {loading ? (
                <div style={{ textAlign: "center", padding: "3rem", color: "hsl(var(--text-2))" }}>
                ...
                <div className="card" style={{ textAlign: "center", padding: "3rem 1rem" }}>
                    ...
                    <p style={{ color: "hsl(var(--text-2))", fontSize: "0.875rem", marginBottom: "1.5rem" }}>
                    ...
                    {activeJobs.map((job) => {
                        ...
                        return (
                            <div key={job.id} className="card" style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
                                    <div>
                                        ...
                                        <div style={{ fontSize: "0.82rem", color: "hsl(var(--text-2))" }}>
                                            Freelancer: <strong style={{ color: "hsl(var(--text))" }}>{job.freelancerName}</strong> · Budget: <strong style={{ color: "hsl(var(--text))" }}>{formatCurrency(job.budget)}</strong>
                                        </div>
                                    </div>
                                ...
                                {/* Escrow bar */}
                                <div style={{ background: "hsl(var(--surface-3))", border: "1px solid hsl(145 65% 42% / 0.2)", borderRadius: 8, padding: "0.875rem" }}>
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-between", marginTop: "0.4rem", fontSize: "0.73rem", color: "hsl(var(--text-2))" }}>
                                ...
                                {hasSubmitted && (
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", background: "hsl(145 65% 42% / 0.08)", border: "1px solid hsl(145 65% 42% / 0.3)", borderRadius: 8, padding: "0.75rem 1rem" }}>
                                        ...
                                        <div style={{ flex: 1 }}>
                                            <span style={{ fontSize: "0.85rem", color: "hsl(var(--text))", fontWeight: 600 }}>
                                    ...
                                    {milestones.map((m, i) => {
                                        ...
                                        return (
                                            <div key={m.id || i} style={{
                                                ...
                                                background: isApproved ? "hsl(145 65% 42% / 0.12)" : isReview ? "hsl(38 92% 50% / 0.1)" : isActive ? "hsl(217 91% 55% / 0.1)" : "hsl(var(--surface-3))",
