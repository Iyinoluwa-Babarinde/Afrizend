...
export default function EmployerDashboard() {
    ...
    const stats = [
        ...
        { label: "Kora Balance", value: formatCurrency(user?.balance || 0), sub: "Secured on Kora", icon: FileText, color: "blue" },
          ...
          <div>
            ...
            <div className="card" style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              {DEMO_FREELANCERS.slice(0, 2).map((f) => (<div key={f.id} style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <div className="avatar" style={{ width: 36, height: 36, fontSize: "0.75rem" }}>{f.avatar}</div>
