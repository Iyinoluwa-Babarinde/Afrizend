...
export default function SessionRoom() {
    ...
    return (
        <div style={{ height: "calc(100vh - 56px)", display: "flex", flexDirection: "column", background: "black" }}>
            {/* Room Header */}
            <div style={{ padding: "1rem 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", background: "hsl(var(--surface-2))", borderBottom: "1px solid hsl(var(--border))" }}>
                <div>
                    <h1 className="font-heading" style={{ fontSize: "1.1rem", fontWeight: 700, color: "hsl(var(--text))" }}>Advisory Session</h1>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.75rem", color: "hsl(var(--text-2))", marginTop: 4 }}>
                ...
                {/* Live Meter */}
                {inCall && (
                    <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", background: "hsl(var(--surface-3))", padding: "0.5rem 1rem", borderRadius: 8, border: "1px solid hsl(200 100% 60% / 0.3)" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                            <div className="status-dot online animate-blink" />
                            <span style={{ fontSize: "0.85rem", fontWeight: 600, color: "hsl(var(--text))", fontFamily: "monospace" }}>{formatDuration(duration)}</span>
                        </div>
                        <div style={{ width: 1, height: 20, background: "hsl(var(--surface-4))" }} />
                        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem", position: "relative" }}>
                {!inCall ? (
                    <div className="card" style={{ maxWidth: 400, width: "100%", textAlign: "center" }}>
                        ...
                        <h2 className="font-heading" style={{ fontSize: "1.2rem", color: "hsl(var(--text))", marginBottom: "0.5rem" }}>Ready to join?</h2>
                    ...
                    <div style={{ width: "100%", height: "100%", maxWidth: 1000, background: "hsl(var(--surface-2))", borderRadius: 16, border: "1px solid hsl(var(--border))", position: "relative", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        ...
                        {!connected ? (
                            <div style={{ textAlign: "center", zIndex: 10 }}>
                                <div className="spinner" style={{ margin: "0 auto 1rem", width: 40, height: 40, border: "3px solid hsl(var(--border))", borderTopColor: "hsl(var(--primary))", borderRadius: "50%", animation: "spin 1s linear infinite" }} />
            ...
            {/* Controls */}
            {inCall && (
                <div style={{ padding: "1rem", background: "hsl(var(--surface-2))", borderTop: "1px solid hsl(var(--border))", display: "flex", justifyContent: "center", gap: "1rem" }}>
                    ...
                    <div style={{ width: 1, height: 48, background: "hsl(var(--surface-4))", margin: "0 0.5rem" }} />
                    <button onClick={endCall} style={{
                        ...
                        background: "hsl(0 84% 50%)", color: "hsl(var(--text))"
                    }}>
                        <PhoneOff size={20} />
                    </button>
                </div>
