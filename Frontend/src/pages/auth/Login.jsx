...
function LoginForm() {
    ...
    async function handleSubmit(e) {
        ...
        setError("");
        try {
            // Re-route to backend authentication
    ...
    return (<div style={{ minHeight: "100vh", background: "hsl(0 0% 4%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
      ...
      <div style={{ position: "relative", width: "100%", maxWidth: 420 }}>
        <Link to="/" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", marginBottom: "2rem", textDecoration: "none" }}>
          <div className="logo-icon-small" style={{ width: 32, height: 32, background: "linear-gradient(135deg, #4da6ff, #0066ff)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Zap size={18} color="#050505" fill="#050505" />
          </div>
          <span style={{ fontSize: "1.8rem", fontWeight: 800, color: "white" }}>Afri<span className="text-gradient-blue">zend</span></span>
        </Link>

        <div className="card" style={{ padding: "2rem" }}>
          <h1 className="font-heading" style={{ fontSize: "1.5rem", fontWeight: 800, color: "white", marginBottom: "0.25rem" }}>Welcome back</h1>
          <p style={{ color: "hsl(220 15% 55%)", fontSize: "0.875rem", marginBottom: "1.5rem" }}>Sign in to your Afrizend account</p>
