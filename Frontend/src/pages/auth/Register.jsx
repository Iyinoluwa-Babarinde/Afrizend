  ...
  return (<>
    ...
    <div className="card" style={{ padding: "2rem" }}>
      ...
      {step === 2 && (<div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        <div>
          <h2 className="font-heading" style={{ fontSize: "1.3rem", fontWeight: 800, color: "white" }}>Connect Kora Virtual Account</h2>
          <p style={{ color: "hsl(220 15% 55%)", fontSize: "0.85rem", marginTop: 4 }}>Your virtual bank details — where you receive and settle global payouts locally</p>
        </div>
        <div style={{ background: "hsl(217 91% 55% / 0.08)", border: "1px solid hsl(217 91% 55% / 0.2)", borderRadius: 8, padding: "0.875rem", fontSize: "0.8rem", color: "hsl(217 91% 70%)" }}>
          <strong>What&apos;s a Kora Virtual Account?</strong> An instantly-provisioned account that lets you collect payments in USD, GBP, or EUR, and instantly cash out to African local bank accounts (NGN, KES, GHS, etc.) at competitive FX rates.
        </div>
        <div>
          <label style={{ display: "block", fontSize: "0.8rem", fontWeight: 600, color: "hsl(220 15% 65%)", marginBottom: "0.4rem" }}>Kora Payout Pointer</label>
          <div style={{ display: "flex", alignItems: "center", background: "hsl(220 20% 12%)", borderRadius: 8, border: "1px solid hsl(220 20% 18%)", overflow: "hidden", transition: "border-color 0.2s" }}>
            <span style={{ padding: "0 0.75rem", fontSize: "0.85rem", color: "hsl(220 15% 55%)", borderRight: "1px solid hsl(220 20% 18%)", background: "hsl(220 20% 10%)" }}>@kora.afrizend.dev/</span>
          ...
          <p style={{ fontSize: "0.75rem", color: "hsl(220 15% 45%)", marginTop: "0.35rem" }}>Leave blank to use your auto-generated Afrizend virtual account</p>
        </div>
        <div style={{ display: "flex", gap: "0.75rem" }}>
  ...
  return (<div style={{ minHeight: "100vh", background: "hsl(0 0% 4%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
    ...
    <div style={{ position: "relative", width: "100%", maxWidth: 460 }}>
      <Link to="/" style={{ display: "flex", alignItems: "center", gap: "0.5rem", justifyContent: "center", marginBottom: "2rem", textDecoration: "none" }}>
        <div className="logo-icon-small" style={{ width: 28, height: 28, background: "linear-gradient(135deg, #4da6ff, #0066ff)", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <Zap size={15} color="#050505" fill="#050505" />
        </div>
        <span style={{ fontSize: "1.6rem", fontWeight: 800, color: "white" }}>Afri<span className="text-gradient-blue">zend</span></span>
      </Link>
